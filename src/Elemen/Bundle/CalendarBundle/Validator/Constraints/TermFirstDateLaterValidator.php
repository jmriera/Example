...
class TermFirstDateLaterValidator extends ConstraintValidator
{
    /**
    ...
    public function validate($value, Constraint $constraint)
    {
        ...
        if ($value->getTimestamp() < $valueCompare->getStartDate()->getTimestamp()) {
            $this->context->addViolation($constraint->message,['{{date}}' => $valueCompare->getStartDate()->format('d/m/Y') ]);
        }
    }
}
